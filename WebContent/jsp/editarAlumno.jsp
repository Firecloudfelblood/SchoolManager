			...
			<form class="col s12" action="AlumnoController" method="post">
				<div class="row">
					<div class="input-field col s12">
						...
						<input value="<%=alumno.getName()%>" id="name" type="text"
							name="nombre" /> <label for="name">Nombre</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s12">
						<!-- AGREGA EL EMAIL DEL USUARIO EN EL CAMPO value -->
						<input id="email" value="<%=alumno.getEmail()%>" type="email"
							name="email" /> <label for="email">Correo</label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col s6">
						<!-- AGREGA LA EDAD DEL USUARIO EN EL CAMPO value -->
						<input value="<%=alumno.getEdad()%>" id="edad" type="number"
							name="edad" /> <label for="edad">Edad</label>
					</div>
					...
					<div class="input-field col s6">
						<select name="genero">
							...
							%>
						</select> <label>Genero</label>
					</div>
				</div>
				<div class="row">
					<div class="col s12">
						<button style="width: 100%;" class="btn waves-effect waves-light"
							type="submit" name="action">
							Guardar Cambios <i class="material-icons right">send</i>
						</button>
						<!--ESTE ES UN ATRIBUTO OCULTO, LO RECUPERAS EN TU SERVLET CON request.getParameter("accion") -->
